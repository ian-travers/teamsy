    ...
    <div class="grid grid-cols-6 mb-4">
        <div class="col-span-6 sm:col-span-1 pr-2">
            ...
            <select
                wire:model="perPage"
                id="location"
                class="w-full block text-base leading-6 border-gray-300 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 sm:text-sm sm:leading-5 mt-1 pl-3 pr-10 py-2"
            >
                <option>10</option>
                <option>15</option>
                <option>20</option>
